...
//    var verses: [String]?
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if let verseViewCell = cell as? BibleVerseTableViewCell {
            verseViewCell.verseLabel.text = String(indexPath.item + 1) + " " +  verses.unsafelyUnwrapped[indexPath.item].text.trimmingCharacters(in: .whitespaces)
        }
